...
% OUTPUTS
%
%	  theChosen:     chosen items. cell array unless N chosen is 1 (CHAR) or 0 (empty array)
%	  theChosenIDX:  numeric idx to input cell array of choices
%
% ________________________________________________________________________________________
% INPUTS
%
%	  theCell:  cell array of items to choose from. cell contents must be type CHAR.
%
% ________________________________________________________________________________________
...
if ishandle(fige)
    if get(fige, 'UserData')
        ...
        if any(idx)
            ...
            if length(theChosen)==1, theChosen = char(theChosen); end
